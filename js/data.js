...
const BRACKETS = [
  ...
  { id: 'winnie', accent: 'purple1', title: '2026 WGA Winnie Cup', sub: null, size: 16,
    rounds: [
      { label: 'Quarterfinals', due: 'Jul 31' },
      { label: 'Semifinals', due: 'Aug 30' },
    ],
